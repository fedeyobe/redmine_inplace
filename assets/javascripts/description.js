...
const SVG_VALID = '<span id="valid_svg" style="display: none;" onclick="updateIssue();"><svg style="width: 20px; height: 20px; fill:#27ae60;" version="1.1" viewBox="0 0 24 24" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g id="info"/><g id="icons"><path d="M10,18c-0.5,0-1-0.2-1.4-0.6l-4-4c-0.8-0.8-0.8-2,0-2.8c0.8-0.8,2.1-0.8,2.8,0l2.6,2.6l6.6-6.6   c0.8-0.8,2-0.8,2.8,0c0.8,0.8,0.8,2,0,2.8l-8,8C11,17.8,10.5,18,10,18z" class="svg_check"/></g></svg></span>';
const SVG_CANCEL = '<span id="refuse_svg" style="display: none;" onclick="refuseEdit();"><svg style="width: 20px; height: 20px; fill: #c0392b;" version="1.1" viewBox="0 0 24 24" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g id="info"/><g id="icons"><path d="M14.8,12l3.6-3.6c0.8-0.8,0.8-2,0-2.8c-0.8-0.8-2-0.8-2.8,0L12,9.2L8.4,5.6c-0.8-0.8-2-0.8-2.8,0   c-0.8,0.8-0.8,2,0,2.8L9.2,12l-3.6,3.6c-0.8,0.8-0.8,2,0,2.8C6,18.8,6.5,19,7,19s1-0.2,1.4-0.6l3.6-3.6l3.6,3.6   C16,18.8,16.5,19,17,19s1-0.2,1.4-0.6c0.8-0.8,0.8-2,0-2.8L14.8,12z" class="svg_cancel"/></g></svg></span>';
var insrtedImages = [];
const attachmentId = 1;
const uploadUrl = '/uploads.js';
const issueUrl = window.location.origin;
const currentURL = window.location.href;
const issueId = new URL(currentURL).pathname;
...
$(document).ready(function () {
    ...
    $('.description .iconEdit').on('click', function () {
        ...
        const validSVG = document.getElementById('valid_svg');
        const refuseSGV = document.getElementById('refuse_svg');
...
function handleFileUpload(file) {
    ...
    const progressSpan = $('<div>').insertAfter(fileSpan.find('input.filename'));
    return new Promise((resolve, reject) => {
        ...
        apiResponse.then(response => {
            const tokenRegex = /input\.token'\)\.val\('([^']+)'\)/;
...
function bold_convert(text) {
    ...
    patterns.forEach((pattern, index) => {
        ...
        result = result.replace(pattern, () => {
            const tag = useOpeningTag ? tags[index][0] : tags[index][1];
...
function removeStyle(htmlString) {
    ...
    const strippedString = doc.body.innerHTML;
